...
def builtin_search_space(profile: str) -> List[SearchParamSpec]:
    if profile == "aggressive":
        return [
            ...
            SearchParamSpec(name="channel_independence", type="categorical", values=[0, 1]),
            SearchParamSpec(name="down_sampling_layers", type="categorical", values=[1, 2, 3]),
            SearchParamSpec(name="down_sampling_window", type="categorical", values=[2, 3]),
            SearchParamSpec(name="down_sampling_method", type="categorical", values=["avg", "max", "conv"]),
            SearchParamSpec(name="decomp_method", type="categorical", values=["moving_avg", "dft_decomp"]),
            SearchParamSpec(name="moving_avg", type="categorical", values=[13, 25]),
            SearchParamSpec(name="top_k", type="categorical", values=[3, 5, 7]),
    ...
    return [
        ...
        SearchParamSpec(name="channel_independence", type="categorical", values=[0, 1]),
        SearchParamSpec(name="down_sampling_layers", type="categorical", values=[1, 2]),
        SearchParamSpec(name="down_sampling_window", type="categorical", values=[2, 3]),
        SearchParamSpec(name="decomp_method", type="categorical", values=["moving_avg", "dft_decomp"]),
