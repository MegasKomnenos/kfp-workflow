from mambasl_new.cmapss.search_space import builtin_search_space, katib_parameter_specs
from mambasl_new.specs import execution_spec, expand_ablation_cases, load_spec


def test_load_default_spec():
    spec = load_spec("configs/experiments/fd_all_core_default.yaml")
    assert spec.metadata.name == "mambasl-new-fd-all-default"
